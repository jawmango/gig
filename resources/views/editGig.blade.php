...
<div class="container-fluid p-5">
        <div class="col-4 mx-auto p-4  border border-success border-2">
            <h4 class="text-uppercase text-center">Edit Performer</h4>
...
type="text" placeholder="Enter performer name" value="{{ $gig->performer_name }}">
...
type="text" placeholder="Enter Description" value="{{ $gig->description
}}">
@error('description')
<span class="invalid-feedback" role="alert">
<strong>{{ $message }}</strong>
...
type="text" placeholder="Enter Type" value="{{ $gig->gig_type
}}">
@error('gig_type')
<span class="invalid-feedback" role="alert">
<strong>{{ $message }}</strong>
